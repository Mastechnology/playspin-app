...
"""Main entry point for argecnc_vertical_atc.
...
Example:
    ...
    launch argecnc_vertical_atc by saying::

        $ argecnc_vertical_atc --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='argecnc_vertical_atc',
                          vcp_name='argecnc_vertical_atc',
